...
values."
  (setq-default
   ...
   ;; and `nil'. `unused' will lazy install only unused layers (i.8e. layers
...
values."
  ...
  (setq-default
   ...
   ;; (default 'vim)
   dotspacemacs-editing-style 'evil
...
you should place your code here."
  ...
  (setq org-todo-keyword-faces
        '(("TODO" . (:foreground "white" :background "#95A5A6"   :weight bold))
          ...
          ("RESTART" . (:foreground "white" :background "#7b68ee" :weight blod))
          ("PLAN" . (:foreground "white" :background "#cc9966" :weight blod))
          )
   )
  ...
  (setq org-todo-keywords
        '((sequence "TODO(T!)" "DOING(I@/!)" "SUSPEND(S@/!)" "RESTART(R@/!)" "PLAN(P@/!)"  "|" "DONE(D!)" "CANCELED(C@/!)" ))
        )
